...
Use this file to keep the blog strategy consistent across daily runs. Update it when the user gives clearer niche, audience, monetization, or platform direction.

## Platform Priority

1. Naver Blog: primary publishing and draft-save target.
2. Tistory: secondary adaptation target for more structured SEO articles.
...
Readers are busy and want:

- The answer first.
- Clear dates, conditions, and exceptions.
- A simple recommendation by situation or budget.
- Warnings before they waste money or miss a benefit.
- Product comparisons that are honest about trade-offs.

## Default Editorial Stance

- Helpful, practical, slightly conversational.
...
- Overly polished AI-like summaries.
