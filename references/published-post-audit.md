...
2. Public post visuals:
   ...
   - confirm the first image is the approved scene-first asset,
   - confirm visual roles and captions appear in manifest order,
...
- Visual-role order and caption result.
