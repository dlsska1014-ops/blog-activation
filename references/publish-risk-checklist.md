...
For medical, health, finance, investment, legal, childcare, safety, or public benefit topics:

- Avoid diagnosis, guaranteed outcomes, and absolute advice.
- Add uncertainty and source notes.
- Prefer official sources.
- Tell readers to check official terms or professional guidance when appropriate.
...
- Explain who should skip each recommended product.

## Stop Conditions

Do not publish or draft-save until fixed if:
